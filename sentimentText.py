...
positives = []
with open("/Users/sameer/Desktop/PJAS/pos_tweets.txt", "r", encoding='utf-8-sig') as f:
    for l in f:
...
negatives = []
with open("/Users/sameer/Desktop/PJAS/neg_tweets.txt", "r", encoding='utf-8-sig') as f:
    for l in f:
        #expand contradictions
        for k in punctuation:
            l = l.replace(k," ")
